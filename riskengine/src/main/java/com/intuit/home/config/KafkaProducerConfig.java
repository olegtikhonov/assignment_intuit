...
public class KafkaProducerConfig {
    ...
    public KafkaProducerConfig(CommonPropertiesBean commonPropertiesBean) {
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, propertiesBean.getBootstrapAddress());
